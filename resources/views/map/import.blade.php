        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <strong>Справка.</strong> Загружать файлы можно по очереди, либо только xls.<br>
                        При загрузке только kml, работа бессмысленна. Геометки будут на карте, но ничего не выгрузится.<br>
                        При загрузке содержимое таблиц замещается.<br>
                        Сначала создается таблица геоточек.<br>
                        Затем создается таблица УТ-номеров, привязанная к таблице геоточек.<br>
                        Если УТ-номер в геоточках не найдется, то строка не будет загружена.<br>
                        Если будет две строки с одним УТ-номером - сохранятся обе.<br>
                        В результирующей export.xls адрес будет взят из таблицы геоточек.<br>
                    </div>
                </div>
            </div>
        </div>
